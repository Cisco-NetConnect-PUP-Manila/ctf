...
import RegistrationAvailabilityGate from "../components/auth/RegistrationAvailabilityGate";
      ...
      <RegistrationAvailabilityGate>
        <div className="shell auth-page__shell">
          <Reveal className="auth-page__intro">
            ...
            <p>
              Create one shared account for your group. The team login email must
              belong to the listed team leader.
            </p>
            <p className="auth-intro-link">
              Review the <Link href="/#rules">official rules</Link> before registering.
            </p>
          </Reveal>
